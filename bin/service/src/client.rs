//! Asterism Client meta trait

/// Asterism client abstraction, this super trait only pulls in functionality required for
/// Asterism internal crates.
// --- crates ---
pub use codec::Codec;
use lyra_primitives::{AccountId, AuraId, Balance, BlockNumber, Nonce, OpaqueBlock as Block};
use sp_runtime::traits::BlakeTwo256;
// use sp_consensus::BlockStatus;
// use lyra_primitives::{Hash, Header};
...
/// A set of APIs that Asterism-like runtimes must implement.
...
pub trait AsterismClient<Block, Backend, Runtime>:
    Sized
    + Send
    + Sync
...
impl<Block, Backend, Runtime, Client> AsterismClient<Block, Backend, Runtime> for Client
where
    Backend: sc_client_api::Backend<Block>,
    Block: sp_runtime::traits::Block,
    Client: Sized
