...
use asterism_rpc::quark::FullDeps;
use lyra_primitives::OpaqueBlock as Block;
pub use quark_runtime;
...
native_executor_instance!(
    pub QuarkExecutor,
    quark_runtime::api::dispatch,
    quark_runtime::native_version,
        ...
        RuntimeApiCollection<StateBackend = StateBackendFor<FullBackend, Block>>,
{
    ...
    let rpc_extensions_builder = {
        ...
        Box::new(move |deny_unsafe, _| {
            ...
            asterism_rpc::quark::create_full(deps)
        })
    };
...
pub fn quark_new_full(
    ...
    (
        TaskManager,
        Arc<impl AsterismClient<Block, FullBackend, quark_runtime::RuntimeApi>>,
    ),
    ServiceError,
> {
    let (components, client) = new_full::<quark_runtime::RuntimeApi, QuarkExecutor>(config)?;
...
pub fn quark_new_light(config: Configuration) -> Result<TaskManager, ServiceError> {
    new_light::<quark_runtime::RuntimeApi, QuarkExecutor>(config)
}