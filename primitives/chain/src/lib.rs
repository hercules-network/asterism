...
fn print_module_account() {
    ...
    account_of(*b"lyr/nftb", SubstrateAccount);
    ...
    account_of(*b"lyr/soci", SubstrateAccount);
    ...
    account_of(*b"lyr/phre", SubstrateAccount);
}
...
fn print_evm_account() {
    ...
    HashedAddressMapping::into_account_id(
        H160::from_str("6C097fB92092793608fB3860509100BE23c4f20F").unwrap(),
    );

    // address: 0x7184035beead581f3dcedecba5db6547a914fbb9
    // accountId: 5EdYV3AszLFPYBQdGxWhJoawFfMBXGyCUgzPZznF5LZUFKS8
    HashedAddressMapping::into_account_id(
        H160::from_str("7184035beEAD581f3dcEDeCBa5dB6547A914fBB9").unwrap(),
    );
}
